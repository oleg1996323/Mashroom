...
using SublimedGribDataInfo = SublimedFormatDataInfo<Data_t::TIME_SERIES,Data_f::GRIB_v1>;
...
using GribProxyDataInfo = ProxyDataInfo<Data_t::TIME_SERIES,Data_f::GRIB_v1>;

template<>
class ProxyDataInfo<Data_t::TIME_SERIES,Data_f::GRIB_v1>{
    public:
...
template<>
class SublimedFormatDataInfo<Data_t::TIME_SERIES,Data_f::GRIB_v1>
{
    public:
    using sublimed_data_t = std::unordered_map<path::Storage<false>,
    std::map<std::shared_ptr<Grib1CommonDataProperties>,std::deque<SublimedDataInfoStruct<Data_t::TIME_SERIES,Data_f::GRIB_v1>>>>;
    template<bool,auto>
...
static_assert(serialization::serialize_concept<true,std::pair<std::shared_ptr<Grib1CommonDataProperties> const, std::vector<SublimedDataInfoStruct<Data_t::TIME_SERIES,Data_f::GRIB_v1>, std::allocator<SublimedDataInfoStruct<Data_t::TIME_SERIES,Data_f::GRIB_v1>>>>>);
static_assert(serialization::serialize_concept<false,std::pair<std::shared_ptr<Grib1CommonDataProperties> const, std::vector<SublimedDataInfoStruct<Data_t::TIME_SERIES,Data_f::GRIB_v1>, std::allocator<SublimedDataInfoStruct<Data_t::TIME_SERIES,Data_f::GRIB_v1>>>>>);
...
static_assert(serialization::deserialize_concept<true,std::vector<SublimedDataInfoStruct<Data_t::TIME_SERIES,Data_f::GRIB_v1>>>);
static_assert(serialization::deserialize_concept<false,std::vector<SublimedDataInfoStruct<Data_t::TIME_SERIES,Data_f::GRIB_v1>>>);
static_assert(serialization::serialize_concept<true,std::unordered_map<path::Storage<false>,std::map<std::shared_ptr<Grib1CommonDataProperties>,std::vector<SublimedDataInfoStruct<Data_t::TIME_SERIES,Data_f::GRIB_v1>>>>>);
static_assert(serialization::serialize_concept<false,std::unordered_map<path::Storage<false>,std::map<std::shared_ptr<Grib1CommonDataProperties>,std::vector<SublimedDataInfoStruct<Data_t::TIME_SERIES,Data_f::GRIB_v1>>>>>);
//std::unordered_map<path::Storage<false>,std::map<std::shared_ptr<CommonDataProperties>,std::vector<SublimedDataInfoStruct<Data_t::TIME_SERIES,Data_f::GRIB_v1>>>>