...
const ParmTable ParmTable_2_128[256] = {
    {"Unknown", "Unknown"}, //0
    {"STRF", "Stream function m**2 s**-1 -"}, //1
    {"VPOT", "Velocity potential m**2 s**-1 -"}, //2
    {"PT", "Potential temperature K -"}, //3
    {"EQPT", "Equivalent potential temperature K -"}, //4
    {"SEPT", "Saturated equivalent potential temperature K -"}, //5
    {"None", "Reserved for Metview - -"}, //6
    {"None", "Reserved for Metview - -"}, //7
    {"None", "Reserved for Metview - -"}, //8
    {"None", "Reserved for Metview - -"}, //9
    {"None", "Reserved for Metview - -"}, //10
    {"UDVW", "U component of divergent wind m s**-1 -"}, //11
    {"VDVW", "V component of divergent wind m s**-1 -"}, //12
    {"URTW", "U component of rotational wind m s**-1 -"}, //13
    {"VRTW", "V component of rotational wind m s**-1 -"}, //14
    {"None", "Reserved for Metview - -"}, //15
    {"None", "Reserved for Metview - -"}, //16
    {"None", "Reserved for Metview - -"}, //17
    {"None", "Reserved for Metview - -"}, //18
    {"None", "Reserved for Metview - -"}, //19
    {"None", "Reserved for Metview - -"}, //20
    {"UCTP", "Unbalanced component of temperature K -"}, //21
    {"UCLN", "Unbalanced component of logarithm of surface pressure - -"}, //22
    {"UCDV", "Unbalanced component of divergence s**-1 -"}, //23
    {"None", "Reserved for future unbalanced components - -"}, //24
    {"None", "Reserved for future unbalanced components - -"}, //25
    {"CL", "Lake cover (0-1) -"}, //26
    {"CVL", "Low vegetation cover (0-1) -"}, //27
    {"CVH", "High vegetation cover (0-1) -"}, //28
    {"TVL", "Type of low vegetation - Table index"}, //29
    {"TVH", "Type of high vegetation - Table index"}, //30
    {"CI", "Sea-ice cover (0-1) -"}, //31
    {"ASN", "Snow albedo (0-1) -"}, //32
    {"RSN", "Snow density kg m**-3 -"}, //33
    {"SSTK", "Sea surface temperature K K"}, //34
    {"ISTL1", "Ice surface temperature layer 1 K -"}, //35
    {"ISTL2", "Ice surface temperature layer 2 K -"}, //36
    {"ISTL3", "Ice surface temperature layer 3 K -"}, //37
    {"ISTL4", "Ice surface temperature layer 4 K -"}, //38
    ...
    {"SWVL4", "Volumetric soil water layer 4 m**3 m**-3 -"}, //42
    {"SLT", "Soil type - -"}, //43
    {"ES", "Snow evaporation m of water Accumulated field"}, //44
    {"SMLT", "Snowmelt m of water Accumulated field"}, //45
    {"SDUR", "Solar duration s -"}, //46
    {"DSRP", "Direct solar radiation w m**-2 Incident on a plane perpendicular to the Sun's direction"}, //47
    {"MAGSS", "Magnitude of surface stress N m**-2 s Accumulated field"}, //48
    {"10FG", "10 metre wind gust m s**-1 Maximum since previous post-processing"}, //49
    {"LSPF", "Large-scale precipitation fraction s Accumulated field"}, //50
    {"MX2T24", "Maximum 2 metre temperature K During previous 24 hours"}, //51
    {"-", "Minimum 2 metre temperature K During previous 24 hours"}, //52
    {"MONT", "Montgomery potential m**2 s**-2 -"}, //53
    {"PRES", "Pressure Pa -"}, //54
    {"-", "Mean 2 metre temperature in past 24 hours K 6-hourly intervals"}, //55
    {"MN2D24", "Mean 2 metre dewpoint temperature in past 24 hours K 6-hourly intervals"}, //56
    {"UVB", "Downward UV radiation at the surface w m**-2 s Ultra-violet band B. Accumulated field."}, //57
    {"PAR", "Photosynthetically active radiation at the surface w m**-2 s Accumulated field."}, //58
    {"CAPE", "Convective available potential energy J kg**-1 -"}, //59
    {"PV", "Potential vorticity K m**2 kg**-1 s**-1 -"}, //60
    {"TPO", "Total precipitation from observations Millimetres*100 + number of stations Rainfall amount found by averaging over a number of observing stations"}, //61
    {"OBCT", "Observation count - Count of observations used in calculating value at a gridpoint"}, //62
    {"-", "Start time for skin temperature difference s Seconds from reference time"}, //63
    {"-", "Finish time for skin temperature difference s Seconds from reference time"}, //64
    {"-", "Skin temperature difference K -"}, //65
    {"-", "Leaf area index, low vegetation m**2 / m**2 -"}, //66
    {"-", "Leaf area index, high vegetation m**2 / m**2 -"}, //67
    {"-", "Minimum stomatal resistance, low vegetation s m**2"}, //68
    {"-", "Minimum stomatal resistance, high vegetation s m**2"}, //69
    {"-", "Biome cover, low vegetation [0,1]"}, //70
    {"-", "Biome cover, high vegetation [0,1]"}, //71
    {"-", "Unused"}, //72
    {"-", "Unused"}, //73
    ...
    {"-", "Unused"}, //76
    {"-", "Unused"}, //77
    {"TCLW", "Total column liquid water kg m**-2"}, //78
    {"TCIW", "Total column ice water kg m**-2"}, //79
    {"80", "Experimental product Undefined Contents may vary"}, //80
    {"81", "Experimental product Undefined Contents may vary"}, //81
    {"82", "Experimental product Undefined Contents may vary"}, //82
    {"83", "Experimental product Undefined Contents may vary"}, //83
    {"84", "Experimental product Undefined Contents may vary"}, //84
    {"85", "Experimental product Undefined Contents may vary"}, //85
    {"86", "Experimental product Undefined Contents may vary"}, //86
    {"87", "Experimental product Undefined Contents may vary"}, //87
    {"88", "Experimental product Undefined Contents may vary"}, //88
    {"89", "Experimental product Undefined Contents may vary"}, //89
    {"90", "Experimental product Undefined Contents may vary"}, //90
    {"91", "Experimental product Undefined Contents may vary"}, //91
    {"92", "Experimental product Undefined Contents may vary"}, //92
    {"93", "Experimental product Undefined Contents may vary"}, //93
    {"94", "Experimental product Undefined Contents may vary"}, //94
    {"95", "Experimental product Undefined Contents may vary"}, //95
    {"96", "Experimental product Undefined Contents may vary"}, //96
    {"97", "Experimental product Undefined Contents may vary"}, //97
    {"98", "Experimental product Undefined Contents may vary"}, //98
    {"99", "Experimental product Undefined Contents may vary"}, //99
    {"100", "Experimental product Undefined Contents may vary"}, //100
    {"101", "Experimental product Undefined Contents may vary"}, //101
    {"102", "Experimental product Undefined Contents may vary"}, //102
    {"103", "Experimental product Undefined Contents may vary"}, //103
    {"104", "Experimental product Undefined Contents may vary"}, //104
    {"105", "Experimental product Undefined Contents may vary"}, //105
    {"106", "Experimental product Undefined Contents may vary"}, //106
    {"107", "Experimental product Undefined Contents may vary"}, //107
    {"108", "Experimental product Undefined Contents may vary"}, //108
    {"109", "Experimental product Undefined Contents may vary"}, //109
    {"110", "Experimental product Undefined Contents may vary"}, //110
    {"111", "Experimental product Undefined Contents may vary"}, //111
    {"112", "Experimental product Undefined Contents may vary"}, //112
    {"113", "Experimental product Undefined Contents may vary"}, //113
    {"114", "Experimental product Undefined Contents may vary"}, //114
    {"115", "Experimental product Undefined Contents may vary"}, //115
    {"116", "Experimental product Undefined Contents may vary"}, //116
    {"117", "Experimental product Undefined Contents may vary"}, //117
    {"118", "Experimental product Undefined Contents may vary"}, //118
    {"119", "Experimental product Undefined Contents may vary"}, //119
    {"Unknown", "Unknown"}, //120
    {"MX2T6", "Maximum temperature at 2 metres K During previous 6 hours"}, //121
    {"MN2T6", "Minimum temperature at 2 metres K During previous 6 hours"}, //122
    {"10FG6", "10 metre wind gust m s**-1 During previous 6 hours"}, //123
    {"-", "Unused - -"}, //124
    {"-", "Vertically integrated total energy J m**-2 Integrated over a number of model levels"}, //125
    {"-", "Generic parameter for sensitive area prediction Various Originating centre dependent"}, //126
    {"AT", "Atmospheric tide - Not GRIB data"}, //127
    {"BV", "Budget values - Not GRIB data"}, //128
    {"Z", "Geopotential m**2 s**-2 At the surface: orography"}, //129
    {"T", "Temperature K -"}, //130
    {"U", "U velocity m s**-1 -"}, //131
    {"V", "V velocity m s**-1 -"}, //132
    {"Q", "Specific humidity kg kg**-1 -"}, //133
    {"SP", "Surface pressure Pa -"}, //134
    {"W", "Vertical velocity Pa s**-1 -"}, //135
    {"TCW", "Total column water kg m**-2 Liquid + ice + vapour"}, //136
    {"TCWV", "Total column water vapour kg m**-2 -"}, //137
    {"VO", "Vorticity (relative) s**-1 -"}, //138
    {"STL1", "Soil temperature level 1 K Soil temperature (ST) before 19930804"}, //139
    {"SWL1", "Soil wetness level 1 m of water Surface soil wetness (SSW) before 19930804"}, //140
    {"SD", "Snow depth m of water equivalent -"}, //141
    {"LSP", "Large scale precipitation m Accumulated field"}, //142
    {"CP", "Convective precipitation m Accumulated field"}, //143
    {"SF", "Snowfall (convective + stratiform) m of water equivalent Accumulated field"}, //144
    {"BLD", "Boundary layer dissipation W m**-2 s Accumulated field"}, //145
    {"SSHF", "Surface sensible heat flux W m**-2 s Accumulated field"}, //146
    {"SLHF", "Surface latent heat flux W m**-2 s Accumulated field"}, //147
    {"CHNK", "Charnock - Surface stress (SS) before 19980519"}, //148
    {"SNR", "Surface net radiation W m**-2 s Accumulated field"}, //149
    {"TNR", "Top net radiation - -"}, //150
    {"MSL", "Mean sea level pressure Pa -"}, //151
    {"LNSP", "Logarithm of surface pressure - -"}, //152
    {"SWHR", "Short-wave heating rate K Accumulated field"}, //153
    {"LWHR", "Long-wave heating rate K Accumulated field"}, //154
    {"D", "Divergence s**-1 -"}, //155
    {"GH", "Height m Geopotential height"}, //156
    {"R", "Relative humidity % -"}, //157
    {"TSP", "Tendency of surface pressure Pa s**-1 -"}, //158
    {"BLH", "Boundary layer height m -"}, //159
    {"SDOR", "Standard deviation of orography - -"}, //160
    ...
    {"2T", "2 metre temperature K -"}, //167
    {"2D", "2 metre dewpoint temperature K -"}, //168
    {"SSRD", "Surface solar radiation downwards W m**-2 s Accumulated field"}, //169
    {"STL2", "Soil temperature level 2 K Deep soil temperature (DST) before 19930804"}, //170
    {"SWL2", "Soil wetness level 2 m of water Deep soil wetness (DSW) before 19930804. Scaled: depth surf water layer 7cm deep"}, //171
    {"LSM", "Land-sea mask (0, 1) -"}, //172
    {"SR", "Surface roughness m -"}, //173
    {"AL", "Albedo (0 - 1) -"}, //174
    {"STRD", "Surface thermal radiation downwards W m**-2 s Accumulated field"}, //175
    {"SSR", "Surface solar radiation W m**-2 s Accumulated field"}, //176
    {"STR", "Surface thermal radiation W m**-2 s Accumulated field"}, //177
    {"TSR", "Top solar radiation W m**-2 s Accumulated field"}, //178
    {"TTR", "Top thermal radiation W m**-2 s Accumulated field"}, //179
    {"EWSS", "East-West surface stress N m**-2 s Accumulated field"}, //180
    {"NSSS", "North-South surface stress N m**-2 s Accumulated field"}, //181
    {"E", "Evaporation m of water Accumulated field"}, //182
    {"STL3", "Soil temperature level 3 K Climatological deep soil temperature (CDST) before 19930804"}, //183
    {"SWL3", "Soil wetness level 3 m of water Climatological deep soil wetness (CDSW) before 19930804.Scaled depth surf water 7cm deep"}, //184
    {"CCC", "Convective cloud cover (0 - 1) -"}, //185
    {"LCC", "Low cloud cover (0 - 1) -"}, //186
    {"MCC", "Medium cloud cover (0 - 1) -"}, //187
    {"HCC", "High cloud cover (0 - 1) -"}, //188
    {"SUND", "Sunshine duration s Accumulated field"}, //189
    {"EWOV", "East-West component of sub-grid orographic variance m**2 -"}, //190
    {"NSOV", "North-South component of sub-grid orographic variance m**2 -"}, //191
    {"NWOV", "North-West/South-East component of sub-grid orographic variance m**2 -"}, //192
    {"NEOV", "North-East/South-West component of sub-grid orographic variance m**2 -"}, //193
    {"BTMP", "Brightness temperature K -"}, //194
    {"LGWS", "Latitudinal component of gravity wave stress N m**-2 s Accumulated field"}, //195
    {"MGWS", "Meridional component of gravity wave stress N m**-2 s Accumulated field"}, //196
    {"GWD", "Gravity wave dissipation W m**-2 s Accumulated field"}, //197
    {"SRC", "Skin reservoir content m of water -"}, //198
    {"VEG", "Vegetation fraction (0 - 1) -"}, //199
    {"VSO", "Variance of sub-gridscale orography m**2 -"}, //200
    {"MX2T", "Maximum temperature at 2 metres since previous post-processing K -"}, //201
    {"MN2T", "Minimum temperature at 2 metres since previous post-processing K -"}, //202
    {"O3", "Ozone mass mixing ratio kg kg**-1 -"}, //203
    {"PAW", "Precipiation analysis weights - -"}, //204
    {"RO", "Runoff m Accumulated field"}, //205
    {"TCO3", "Total column ozone kg m**-2 Before 20010612 was in Dobsons. 1 Dobson = 2.1415E-5 kg m**-2"}, //206
    {"10SI", "10 metre wind speed m s**-1 -"}, //207
    {"TSRC", "Top net solar radiation, clear sky W m**-2 s Accumulated field"}, //208
    {"TTRC", "Top net thermal radiation, clear sky W m**-2 s Accumulated field"}, //209
    {"SSRC", "Surface net solar radiation, clear sky W m**-2 s Accumulated field"}, //210
    {"STRC", "Surface net thermal radiation, clear sky W m**-2 s Accumulated field"}, //211
    {"SI", "Solar insolation W m**-2 s Accumulated field"}, //212
    {"-", "Unused - -"}, //213
    {"DHR", "Diabatic heating by radiation K -"}, //214
    {"DHVD", "Diabatic heating by vertical diffusion K -"}, //215
    {"DHCC", "Diabatic heating by cumulus convection K -"}, //216
    ...
    {"VDH", "Vertical diffusion of humidity kg kg**-1 -"}, //224
    {"HTCC", "Humidity tendency by cumulus convection kg kg**-1 -"}, //225
    {"HTLC", "Humidity tendency large-scale condensation kg kg**-1 -"}, //226
    {"CRNH", "Change from removing negative humidity kg kg**-1 -"}, //227
    {"TP", "Total precipitation m Accumulated"}, //228
    {"IEWS", "Instantaneous X surface stress N m**-2 -"}, //229
    {"INSS", "Instantaneous Y surface stress N m**-2 -"}, //230
    {"ISHF", "Instantaneous surface heat flux W m**-2 -"}, //231
    {"IE", "Instantaneous moisture flux kg m**-2 s Evaporation"}, //232
    {"ASQ", "Apparent surface humidity kg kg**-1 -"}, //233
    {"LSRH", "Logarithm of surface roughness length for heat - -"}, //234
    {"SKT", "Skin temperature K -"}, //235
    {"STL4", "Soil temperature level 4 K -"}, //236
    {"SWL4", "Soil wetness level 4 m Scaled to depth of surface water layer 7cm deep"}, //237
    {"TSN", "Temperature of snow layer K -"}, //238
    {"CSF", "Convective snowfall m of water equivalent Accumulated field"}, //239
    {"LSF", "Large-scale snowfall m of water equivalent Accumulated field"}, //240
    {"ACF", "Accumulated cloud fraction tendency (-1 to 1) -"}, //241
    {"ALW", "Accumulated liquid water tendency (-1 to 1) -"}, //242
    {"FAL", "Forecast albedo (0 - 1) -"}, //243
    {"FSR", "Forecast surface roughness m -"}, //244
    {"FLSR", "Forecast log of surface roughness for heat - -"}, //245
    {"CLWC", "Cloud liquid water content kg kg**-1 -"}, //246
    {"CIWC", "Cloud ice water content kg kg**-1 -"}, //247
    {"CC", "Fraction of cloud cover (0 - 1) -"}, //248
    {"AIW", "Accumulated ice water tendency (-1 to 1) -"}, //249
    {"ICE", "Ice age 1,0 0 first-year, 1 multi-year"}, //250
    {"ATTE", "Adiabatic tendency of temperature K -"}, //251
    {"ATHE", "Adiabatic tendency of humidity kg kg**-1 -"}, //252
    {"ATZE", "Adiabatic tendency of zonal wind m s**-1 -"}, //253
    {"ATMW", "Adiabatic tendency of meridional wind m s**-1 -"}, //254
...
static_assert(sizeof(ParmTable_2_128)/sizeof(ParmTable_2_128[0])==256);
