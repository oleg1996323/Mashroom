...
template<>
struct FoundDataInfo<Data_t::TIME_SERIES,Data_f::GRIB_v1>{
    ...
    CommonDataProperties<Data_t::TIME_SERIES,Data_f::GRIB_v1>* common_props_;
    std::optional<TimeFrame> fcst_time_;
};

using VariantFoundDataInfo = std::variant<FoundDataInfo<Data_t::TIME_SERIES,Data_f::GRIB_v1>>;
