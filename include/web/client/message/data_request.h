...
namespace network{    
    template<>
    struct Message<network::Client_MsgT::DATA_REQUEST>{
        ExtractForm form_;
        public:
        Message() = default;
...
namespace serialization{
    ...
    template<bool NETWORK_ORDER>
    struct Serialize<NETWORK_ORDER,network::Message<network::Client_MsgT::DATA_REQUEST>>{
        using type = Message<network::Client_MsgT::DATA_REQUEST>;
    ...
    template<bool NETWORK_ORDER>
    struct Deserialize<NETWORK_ORDER,network::Message<network::Client_MsgT::DATA_REQUEST>>{
        using type = Message<network::Client_MsgT::DATA_REQUEST>;
    ...
    template<>
    struct Serial_size<Message<network::Client_MsgT::DATA_REQUEST>>{
        using type = Message<network::Client_MsgT::DATA_REQUEST>;
    ...
    template<>
    struct Min_serial_size<Message<network::Client_MsgT::DATA_REQUEST>>{
        using type = Message<network::Client_MsgT::DATA_REQUEST>;
        static constexpr size_t value = []() ->size_t
        {
    ...
    template<>
    struct Max_serial_size<Message<network::Client_MsgT::DATA_REQUEST>>{
        using type = Message<network::Client_MsgT::DATA_REQUEST>;
        static constexpr size_t value = []() ->size_t
        {
...
static_assert(serialization::deserialize_concept<true,network::Message<network::Client_MsgT::DATA_REQUEST>>);
static_assert(serialization::deserialize_concept<false,network::Message<network::Client_MsgT::DATA_REQUEST>>);
static_assert(serialization::serialize_concept<true,network::Message<network::Client_MsgT::DATA_REQUEST>>);
static_assert(serialization::serialize_concept<false,network::Message<network::Client_MsgT::DATA_REQUEST>>);
static_assert(std::is_move_constructible_v<network::Message<network::Client_MsgT::DATA_REQUEST>>);
static_assert(std::is_move_assignable_v<network::Message<network::Client_MsgT::DATA_REQUEST>>);